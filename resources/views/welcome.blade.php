...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="https://www.amorfa.cat/wp-content/uploads/favicon.ico">

    <title>AMPA-Albaicín</title>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                ...
                <a href="{{ url('/dashboard') }}">
                    <div class="text-4xl bg-blue-200 inline-block py-2 px-4 text-gray-700 bg-white rounded-lg">
                        Ampa Albaicín
                    </div>
                </a>
            </div>
            ...
            <div class="mt-16">
                <img src="https://scontent-mad2-1.xx.fbcdn.net/v/t39.30808-6/310829392_503497731792275_3038944004313535126_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=V1cnA2rWKHsAX9INekN&_nc_ht=scontent-mad2-1.xx&oh=00_AfC7Maun56SKCODVnItJO8sOBo-KOzEU87zooZHl1kFSKA&oe=641100DC"
